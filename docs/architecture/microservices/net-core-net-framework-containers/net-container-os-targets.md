...
| Imagem | Comentários |
|-------|----------|
| mcr.microsoft.com/dotnet/runtime:3.1 | .NET Core 3,1 multiarquiteturas: dá suporte ao Linux e ao Windows nano Server dependendo do host do Docker. |
| mcr.microsoft.com/dotnet/aspnet:3.1 | ASP.NET Core várias arquiteturas 3,1: dá suporte ao Linux e ao Windows nano Server dependendo do host do Docker. <br/> A imagem aspnetcore tem algumas otimizações para ASP.NET Core. |
| mcr.microsoft.com/dotnet/aspnet:3.1-buster-slim | Tempo de execução do .NET Core 3,1 – somente no Linux Debian distribuição |
| mcr.microsoft.com/dotnet/aspnet:3.1-nanoserver-1809 | Tempo de execução do .NET Core 3,1 somente no Windows nano Server (Windows Server versão 1809) |

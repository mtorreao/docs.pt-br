...
Essa regra é habilitada por padrão somente para projetos destinados ao .NET 5,0 ou posterior. No entanto, você pode [habilitá](#configurability) -lo para projetos direcionados a outras estruturas.

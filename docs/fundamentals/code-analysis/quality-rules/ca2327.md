...
Essa regra é acionada quando as duas condições a seguir são verdadeiras para um [Newtonsoft.Json.Jsinstância onSerializerSettings](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_JsonSerializerSettings.htm) :

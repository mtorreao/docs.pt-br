...
- <span data-ttu-id="ca019-124">Você tem um esquema para sua fonte de informações?</span><span class="sxs-lookup"><span data-stu-id="ca019-124">Do you have a schema for your information source?</span></span> <span data-ttu-id="ca019-125">Nesse caso, qual é o mapeamento para o sistema de tipos F # e .NET?</span><span class="sxs-lookup"><span data-stu-id="ca019-125">If so, what’s the mapping into the F# and .NET type system?</span></span>
...
<span data-ttu-id="ca019-146">Para depurar esse provedor usando instruções PRINT, crie um script que expõe um problema com o provedor e, em seguida, use o seguinte código:</span><span class="sxs-lookup"><span data-stu-id="ca019-146">To debug this provider by using print statements, make a script that exposes a problem with the provider, and then use the following code:</span></span>
...
- <span data-ttu-id="ca019-175">Esse tipo fornecido é apagado.</span><span class="sxs-lookup"><span data-stu-id="ca019-175">This provided type is erased.</span></span>  <span data-ttu-id="ca019-176">Como você indica que o tipo base é `obj` , as instâncias serão exibidas como valores do tipo [obj](https://fsharp.github.io/fsharp-core-docs/reference/fsharp-core-obj.html) no código compilado.</span><span class="sxs-lookup"><span data-stu-id="ca019-176">Because you indicate that the base type is `obj`, instances will appear as values of type [obj](https://fsharp.github.io/fsharp-core-docs/reference/fsharp-core-obj.html) in compiled code.</span></span>
...
### <a name="choosing-representations-for-erased-provided-types"></a><span data-ttu-id="ca019-229">Escolhendo representações para tipos fornecidos e apagados</span><span class="sxs-lookup"><span data-stu-id="ca019-229">Choosing Representations for Erased Provided Types</span></span>
...
<span data-ttu-id="ca019-252">Nesse caso, você pode (opcionalmente) usar esse tipo como a eliminação de tipo, especificando esse tipo como o `baseType` ao construir o `ProvidedTypeDefinition` :</span><span class="sxs-lookup"><span data-stu-id="ca019-252">In this case, you may (optionally) use this type as the type erasure by specifying this type as the `baseType` when constructing the `ProvidedTypeDefinition`:</span></span>
...
- <span data-ttu-id="ca019-261">Verificando se uma expressão regular é válida.</span><span class="sxs-lookup"><span data-stu-id="ca019-261">Verifying whether a regular expression is valid.</span></span>
...
|<span data-ttu-id="ca019-319">Distância (medidor)</span><span class="sxs-lookup"><span data-stu-id="ca019-319">Distance (meter)</span></span>|<span data-ttu-id="ca019-320">Tempo (segundo)</span><span class="sxs-lookup"><span data-stu-id="ca019-320">Time (second)</span></span>|
|----------------|-------------|
...
<span data-ttu-id="ca019-344">Observe os seguintes pontos sobre a implementação:</span><span class="sxs-lookup"><span data-stu-id="ca019-344">Note the following points about the implementation:</span></span>
...
<span data-ttu-id="ca019-360">Observe as seguintes convenções ao criar provedores de tipos.</span><span class="sxs-lookup"><span data-stu-id="ca019-360">Observe the following conventions when authoring type providers.</span></span>
...
<span data-ttu-id="ca019-376">Antes de criar um provedor de tipos que é apoiado por dados e serviços remotos, você deve considerar uma variedade de problemas inerentes à programação conectada.</span><span class="sxs-lookup"><span data-stu-id="ca019-376">Before you create a type provider that's backed by remote data and services, you must consider a range of issues that are inherent in connected programming.</span></span> <span data-ttu-id="ca019-377">Esses problemas incluem as seguintes considerações:</span><span class="sxs-lookup"><span data-stu-id="ca019-377">These issues include the following considerations:</span></span>

- <span data-ttu-id="ca019-378">mapeamento de esquema</span><span class="sxs-lookup"><span data-stu-id="ca019-378">schema mapping</span></span>

- <span data-ttu-id="ca019-379">vida e invalidação na presença de alteração de esquema</span><span class="sxs-lookup"><span data-stu-id="ca019-379">liveness and invalidation in the presence of schema change</span></span>

- <span data-ttu-id="ca019-380">cache de esquema</span><span class="sxs-lookup"><span data-stu-id="ca019-380">schema caching</span></span>

- <span data-ttu-id="ca019-381">implementações assíncronas de operações de acesso a dados</span><span class="sxs-lookup"><span data-stu-id="ca019-381">asynchronous implementations of data access operations</span></span>

- <span data-ttu-id="ca019-382">suporte a consultas, incluindo consultas LINQ</span><span class="sxs-lookup"><span data-stu-id="ca019-382">supporting queries, including LINQ queries</span></span>

- <span data-ttu-id="ca019-383">credenciais e autenticação</span><span class="sxs-lookup"><span data-stu-id="ca019-383">credentials and authentication</span></span>

<span data-ttu-id="ca019-384">Este tópico não explora mais esses problemas.</span><span class="sxs-lookup"><span data-stu-id="ca019-384">This topic doesn't explore these issues further.</span></span>

### <a name="additional-authoring-techniques"></a><span data-ttu-id="ca019-385">Técnicas de criação adicionais</span><span class="sxs-lookup"><span data-stu-id="ca019-385">Additional Authoring Techniques</span></span>

<span data-ttu-id="ca019-386">Ao escrever seus próprios provedores de tipo, talvez você queira usar as técnicas adicionais a seguir.</span><span class="sxs-lookup"><span data-stu-id="ca019-386">When you write your own type providers, you might want to use the following additional techniques.</span></span>

### <a name="creating-types-and-members-on-demand"></a><span data-ttu-id="ca019-387">Criando tipos e membros sob demanda</span><span class="sxs-lookup"><span data-stu-id="ca019-387">Creating Types and Members On-Demand</span></span>

<span data-ttu-id="ca019-388">A API fornecida tem versões atrasadas de AddMember.</span><span class="sxs-lookup"><span data-stu-id="ca019-388">The ProvidedType API has delayed versions of AddMember.</span></span>
...
<span data-ttu-id="ca019-389">Essas versões são usadas para criar espaços de tipos sob demanda.</span><span class="sxs-lookup"><span data-stu-id="ca019-389">These versions are used to create on-demand spaces of types.</span></span>

### <a name="providing-array-types-and-generic-type-instantiations"></a><span data-ttu-id="ca019-390">Fornecendo tipos de matriz e instanciações de tipo genérico</span><span class="sxs-lookup"><span data-stu-id="ca019-390">Providing Array types and Generic Type Instantiations</span></span>

<span data-ttu-id="ca019-391">Você faz com que os membros fornecidos (cujas assinaturas incluem tipos de matriz, tipos ByRef e instanciações de tipos genéricos) usando o normal `MakeArrayType` , `MakePointerType` e `MakeGenericType` em qualquer instância do <xref:System.Type> , incluindo `ProvidedTypeDefinitions` .</span><span class="sxs-lookup"><span data-stu-id="ca019-391">You make provided members (whose signatures include array types, byref types, and instantiations of generic types) by using the normal `MakeArrayType`, `MakePointerType`, and `MakeGenericType` on any instance of <xref:System.Type>, including `ProvidedTypeDefinitions`.</span></span>

> [!NOTE]
> <span data-ttu-id="ca019-392">Em alguns casos, talvez seja necessário usar o auxiliar no `ProvidedTypeBuilder.MakeGenericType` .</span><span class="sxs-lookup"><span data-stu-id="ca019-392">In some cases you may have to use the helper in `ProvidedTypeBuilder.MakeGenericType`.</span></span>  <span data-ttu-id="ca019-393">Consulte a [documentação do SDK do provedor de tipos](https://github.com/fsprojects/FSharp.TypeProviders.SDK/blob/master/README.md#explicit-construction-of-code-makegenerictype-makegenericmethod-and-uncheckedquotations) para obter mais detalhes.</span><span class="sxs-lookup"><span data-stu-id="ca019-393">See the [Type Provider SDK documentation](https://github.com/fsprojects/FSharp.TypeProviders.SDK/blob/master/README.md#explicit-construction-of-code-makegenerictype-makegenericmethod-and-uncheckedquotations) for more details.</span></span>

### <a name="providing-unit-of-measure-annotations"></a><span data-ttu-id="ca019-394">Fornecendo anotações de unidade de medida</span><span class="sxs-lookup"><span data-stu-id="ca019-394">Providing Unit of Measure Annotations</span></span>

<span data-ttu-id="ca019-395">A API ProvidedTypes fornece auxiliares para fornecer anotações de medida.</span><span class="sxs-lookup"><span data-stu-id="ca019-395">The ProvidedTypes API provides helpers for providing measure annotations.</span></span> <span data-ttu-id="ca019-396">Por exemplo, para fornecer o tipo `float<kg>` , use o seguinte código:</span><span class="sxs-lookup"><span data-stu-id="ca019-396">For example, to provide the type `float<kg>`, use the following code:</span></span>
...
```
  ...
  <span data-ttu-id="ca019-397">Para fornecer o tipo `Nullable<decimal<kg/m^2>>` , use o seguinte código:</span><span class="sxs-lookup"><span data-stu-id="ca019-397">To provide the type `Nullable<decimal<kg/m^2>>`, use the following code:</span></span>
...
### <a name="accessing-project-local-or-script-local-resources"></a><span data-ttu-id="ca019-398">Acessando recursos Project-Local ou Script-Local</span><span class="sxs-lookup"><span data-stu-id="ca019-398">Accessing Project-Local or Script-Local Resources</span></span>

<span data-ttu-id="ca019-399">Cada instância de um provedor de tipos pode receber um `TypeProviderConfig` valor durante a construção.</span><span class="sxs-lookup"><span data-stu-id="ca019-399">Each instance of a type provider can be given a `TypeProviderConfig` value during construction.</span></span> <span data-ttu-id="ca019-400">Esse valor contém a "pasta de resolução" para o provedor (ou seja, a pasta do projeto para a compilação ou o diretório que contém um script), a lista de assemblies referenciados e outras informações.</span><span class="sxs-lookup"><span data-stu-id="ca019-400">This value contains the "resolution folder" for the provider (that is, the project folder for the compilation or the directory that contains a script), the list of referenced assemblies, and other information.</span></span>

### <a name="invalidation"></a><span data-ttu-id="ca019-401">Invalidação</span><span class="sxs-lookup"><span data-stu-id="ca019-401">Invalidation</span></span>

<span data-ttu-id="ca019-402">Os provedores podem gerar sinais de invalidação para notificar o serviço de linguagem F # que as suposições de esquema podem ter alterado.</span><span class="sxs-lookup"><span data-stu-id="ca019-402">Providers can raise invalidation signals to notify the F# language service that the schema assumptions may have changed.</span></span> <span data-ttu-id="ca019-403">Quando ocorrer invalidação, um typecheck será refeito se o provedor estiver sendo hospedado no Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="ca019-403">When invalidation occurs, a typecheck is redone if the provider is being hosted in Visual Studio.</span></span> <span data-ttu-id="ca019-404">Esse sinal será ignorado quando o provedor for hospedado em F# Interativo ou pelo compilador F # (fsc.exe).</span><span class="sxs-lookup"><span data-stu-id="ca019-404">This signal will be ignored when the provider is hosted in F# Interactive or by the F# Compiler (fsc.exe).</span></span>

### <a name="caching-schema-information"></a><span data-ttu-id="ca019-405">Armazenando em cache informações de esquema</span><span class="sxs-lookup"><span data-stu-id="ca019-405">Caching Schema Information</span></span>

<span data-ttu-id="ca019-406">Os provedores geralmente devem armazenar em cache o acesso a informações de esquema.</span><span class="sxs-lookup"><span data-stu-id="ca019-406">Providers must often cache access to schema information.</span></span> <span data-ttu-id="ca019-407">Os dados armazenados em cache devem ser armazenados usando um nome de arquivo que é fornecido como um parâmetro estático ou como dados do usuário.</span><span class="sxs-lookup"><span data-stu-id="ca019-407">The cached data should be stored by using a file name that's given as a static parameter or as user data.</span></span> <span data-ttu-id="ca019-408">Um exemplo de cache de esquema é o `LocalSchemaFile` parâmetro nos provedores de tipos no `FSharp.Data.TypeProviders` assembly.</span><span class="sxs-lookup"><span data-stu-id="ca019-408">An example of schema caching is the `LocalSchemaFile` parameter in the type providers in the `FSharp.Data.TypeProviders` assembly.</span></span> <span data-ttu-id="ca019-409">Na implementação desses provedores, esse parâmetro estático direciona o provedor de tipos para usar as informações de esquema no arquivo local especificado em vez de acessar a fonte de dados pela rede.</span><span class="sxs-lookup"><span data-stu-id="ca019-409">In the implementation of these providers, this static parameter directs the type provider to use the schema information in the specified local file instead of accessing the data source over the network.</span></span> <span data-ttu-id="ca019-410">Para usar as informações de esquema em cache, você também deve definir o parâmetro estático `ForceUpdate` como `false` .</span><span class="sxs-lookup"><span data-stu-id="ca019-410">To use cached schema information, you must also set the static parameter `ForceUpdate` to `false`.</span></span> <span data-ttu-id="ca019-411">Você pode usar uma técnica semelhante para habilitar o acesso a dados online e offline.</span><span class="sxs-lookup"><span data-stu-id="ca019-411">You could use a similar technique to enable online and offline data access.</span></span>

### <a name="backing-assembly"></a><span data-ttu-id="ca019-412">Assembly de backup</span><span class="sxs-lookup"><span data-stu-id="ca019-412">Backing Assembly</span></span>

<span data-ttu-id="ca019-413">Quando você compila um `.dll` `.exe` arquivo ou, o arquivo. dll de backup para tipos gerados é vinculado estaticamente ao assembly resultante.</span><span class="sxs-lookup"><span data-stu-id="ca019-413">When you compile a `.dll` or `.exe` file, the backing .dll file for generated types is statically linked into the resulting assembly.</span></span> <span data-ttu-id="ca019-414">Esse link é criado copiando as definições de tipo IL (linguagem intermediária) e todos os recursos gerenciados do assembly de backup para o assembly final.</span><span class="sxs-lookup"><span data-stu-id="ca019-414">This link is created by copying the Intermediate Language (IL) type definitions and any managed resources from the backing assembly into the final assembly.</span></span> <span data-ttu-id="ca019-415">Quando você usa F# Interativo, o arquivo. dll de backup não é copiado e, em vez disso, é carregado diretamente no processo de F# Interativo.</span><span class="sxs-lookup"><span data-stu-id="ca019-415">When you use F# Interactive, the backing .dll file isn't copied and is instead loaded directly into the F# Interactive process.</span></span>

### <a name="exceptions-and-diagnostics-from-type-providers"></a><span data-ttu-id="ca019-416">Exceções e diagnósticos de provedores de tipos</span><span class="sxs-lookup"><span data-stu-id="ca019-416">Exceptions and Diagnostics from Type Providers</span></span>

<span data-ttu-id="ca019-417">Todos os usos de todos os membros de tipos fornecidos podem gerar exceções.</span><span class="sxs-lookup"><span data-stu-id="ca019-417">All uses of all members from provided types may throw exceptions.</span></span> <span data-ttu-id="ca019-418">Em todos os casos, se um provedor de tipos lançar uma exceção, o compilador do host irá reattributeá-lo para um provedor de tipos específico.</span><span class="sxs-lookup"><span data-stu-id="ca019-418">In all cases, if a type provider throws an exception, the host compiler attributes the error to a specific type provider.</span></span>

- <span data-ttu-id="ca019-419">Exceções de provedor de tipo nunca devem resultar em erros de compilador interno.</span><span class="sxs-lookup"><span data-stu-id="ca019-419">Type provider exceptions should never result in internal compiler errors.</span></span>

- <span data-ttu-id="ca019-420">Os provedores de tipos não podem relatar avisos.</span><span class="sxs-lookup"><span data-stu-id="ca019-420">Type providers can't report warnings.</span></span>

- <span data-ttu-id="ca019-421">Quando um provedor de tipos é hospedado no compilador F #, em um ambiente de desenvolvimento F # ou F# Interativo, todas as exceções desse provedor são detectadas.</span><span class="sxs-lookup"><span data-stu-id="ca019-421">When a type provider is hosted in the F# compiler, an F# development environment, or F# Interactive, all exceptions from that provider are caught.</span></span> <span data-ttu-id="ca019-422">A propriedade Message sempre é o texto de erro e nenhum rastreamento de pilha é exibido.</span><span class="sxs-lookup"><span data-stu-id="ca019-422">The Message property is always the error text, and no stack trace appears.</span></span> <span data-ttu-id="ca019-423">Se você for lançar uma exceção, poderá lançar os seguintes exemplos: `System.NotSupportedException` , `System.IO.IOException` , `System.Exception` .</span><span class="sxs-lookup"><span data-stu-id="ca019-423">If you’re going to throw an exception, you can throw the following examples: `System.NotSupportedException`, `System.IO.IOException`, `System.Exception`.</span></span>

#### <a name="providing-generated-types"></a><span data-ttu-id="ca019-424">Fornecendo tipos gerados</span><span class="sxs-lookup"><span data-stu-id="ca019-424">Providing Generated Types</span></span>

<span data-ttu-id="ca019-425">Até agora, este documento explicou como fornecer tipos apagados.</span><span class="sxs-lookup"><span data-stu-id="ca019-425">So far, this document has explained how to provide erased types.</span></span> <span data-ttu-id="ca019-426">Você também pode usar o mecanismo do provedor de tipos em F # para fornecer tipos gerados, que são adicionados como definições de tipo .NET reais no programa dos usuários.</span><span class="sxs-lookup"><span data-stu-id="ca019-426">You can also use the type provider mechanism in F# to provide generated types, which are added as real .NET type definitions into the users' program.</span></span> <span data-ttu-id="ca019-427">Você deve referir-se aos tipos fornecidos gerados usando uma definição de tipo.</span><span class="sxs-lookup"><span data-stu-id="ca019-427">You must refer to generated provided types by using a type definition.</span></span>
...
<span data-ttu-id="ca019-428">O código auxiliar ProvidedTypes-0,2 que faz parte da versão F # 3,0 tem apenas suporte limitado para fornecer tipos gerados.</span><span class="sxs-lookup"><span data-stu-id="ca019-428">The ProvidedTypes-0.2 helper code that is part of the F# 3.0 release has only limited support for providing generated types.</span></span> <span data-ttu-id="ca019-429">As instruções a seguir devem ser verdadeiras para uma definição de tipo gerada:</span><span class="sxs-lookup"><span data-stu-id="ca019-429">The following statements must be true for a generated type definition:</span></span>

- <span data-ttu-id="ca019-430">`isErased` deve ser definido como `false`.</span><span class="sxs-lookup"><span data-stu-id="ca019-430">`isErased` must be set to `false`.</span></span>

- <span data-ttu-id="ca019-431">O tipo gerado deve ser adicionado a um recém-criado `ProvidedAssembly()` , que representa um contêiner para fragmentos de código gerados.</span><span class="sxs-lookup"><span data-stu-id="ca019-431">The generated type must be added to a newly constructed `ProvidedAssembly()`, which represents a container for generated code fragments.</span></span>

- <span data-ttu-id="ca019-432">O provedor deve ter um assembly que tenha um arquivo .NET. dll de backup real com um arquivo. dll correspondente no disco.</span><span class="sxs-lookup"><span data-stu-id="ca019-432">The provider must have an assembly that has an actual backing .NET .dll file with a matching .dll file on disk.</span></span>

## <a name="rules-and-limitations"></a><span data-ttu-id="ca019-433">Regras e limitações</span><span class="sxs-lookup"><span data-stu-id="ca019-433">Rules and Limitations</span></span>

<span data-ttu-id="ca019-434">Ao escrever provedores de tipo, mantenha as seguintes regras e limitações em mente.</span><span class="sxs-lookup"><span data-stu-id="ca019-434">When you write type providers, keep the following rules and limitations in mind.</span></span>

### <a name="provided-types-must-be-reachable"></a><span data-ttu-id="ca019-435">Os tipos fornecidos devem estar acessíveis</span><span class="sxs-lookup"><span data-stu-id="ca019-435">Provided types must be reachable</span></span>

<span data-ttu-id="ca019-436">Todos os tipos fornecidos devem ser acessíveis a partir de tipos não aninhados.</span><span class="sxs-lookup"><span data-stu-id="ca019-436">All provided types should be reachable from the non-nested types.</span></span> <span data-ttu-id="ca019-437">Os tipos não aninhados são fornecidos na chamada ao `TypeProviderForNamespaces` Construtor ou a uma chamada para `AddNamespace` .</span><span class="sxs-lookup"><span data-stu-id="ca019-437">The non-nested types are given in the call to the `TypeProviderForNamespaces` constructor or a call to `AddNamespace`.</span></span> <span data-ttu-id="ca019-438">Por exemplo, se o provedor fornecer um tipo `StaticClass.P : T` , você deve garantir que T seja um tipo não aninhado ou aninhado em um.</span><span class="sxs-lookup"><span data-stu-id="ca019-438">For example, if the provider provides a type `StaticClass.P : T`, you must ensure that T is either a non-nested type or nested under one.</span></span>

<span data-ttu-id="ca019-439">Por exemplo, alguns provedores têm uma classe estática, como `DataTypes` a que contém esses `T1, T2, T3, ...` tipos.</span><span class="sxs-lookup"><span data-stu-id="ca019-439">For example, some providers have a static class such as `DataTypes` that contain these `T1, T2, T3, ...` types.</span></span> <span data-ttu-id="ca019-440">Caso contrário, o erro indica que uma referência ao tipo T no assembly A foi encontrada, mas o tipo não pôde ser encontrado nesse assembly.</span><span class="sxs-lookup"><span data-stu-id="ca019-440">Otherwise, the error says that a reference to type T in assembly A was found, but the type couldn't be found in that assembly.</span></span> <span data-ttu-id="ca019-441">Se esse erro for exibido, verifique se todos os seus subtipos podem ser acessados dos tipos de provedor.</span><span class="sxs-lookup"><span data-stu-id="ca019-441">If this error appears, verify that all your subtypes can be reached from the provider types.</span></span> <span data-ttu-id="ca019-442">Observação: esses `T1, T2, T3...` tipos são chamados de tipos *em funcionamento* .</span><span class="sxs-lookup"><span data-stu-id="ca019-442">Note: These `T1, T2, T3...` types are referred to as the *on-the-fly* types.</span></span> <span data-ttu-id="ca019-443">Lembre-se de colocá-los em um namespace acessível ou em um tipo pai.</span><span class="sxs-lookup"><span data-stu-id="ca019-443">Remember to put them in an accessible namespace or a parent type.</span></span>

### <a name="limitations-of-the-type-provider-mechanism"></a><span data-ttu-id="ca019-444">Limitações do mecanismo do provedor de tipos</span><span class="sxs-lookup"><span data-stu-id="ca019-444">Limitations of the Type Provider Mechanism</span></span>

<span data-ttu-id="ca019-445">O mecanismo do provedor de tipos no F # tem as seguintes limitações:</span><span class="sxs-lookup"><span data-stu-id="ca019-445">The type provider mechanism in F# has the following limitations:</span></span>

- <span data-ttu-id="ca019-446">A infraestrutura subjacente para provedores de tipo no F # não dá suporte a tipos genéricos fornecidos ou métodos genéricos fornecidos.</span><span class="sxs-lookup"><span data-stu-id="ca019-446">The underlying infrastructure for type providers in F# doesn't support provided generic types or provided generic methods.</span></span>

- <span data-ttu-id="ca019-447">O mecanismo não dá suporte a tipos aninhados com parâmetros estáticos.</span><span class="sxs-lookup"><span data-stu-id="ca019-447">The mechanism doesn't support nested types with static parameters.</span></span>

## <a name="development-tips"></a><span data-ttu-id="ca019-448">Dicas de desenvolvimento</span><span class="sxs-lookup"><span data-stu-id="ca019-448">Development Tips</span></span>

<span data-ttu-id="ca019-449">Você pode encontrar as seguintes dicas úteis durante o processo de desenvolvimento:</span><span class="sxs-lookup"><span data-stu-id="ca019-449">You might find the following tips helpful during the development process:</span></span>

### <a name="run-two-instances-of-visual-studio"></a><span data-ttu-id="ca019-450">Executar duas instâncias do Visual Studio</span><span class="sxs-lookup"><span data-stu-id="ca019-450">Run two instances of Visual Studio</span></span>

<span data-ttu-id="ca019-451">Você pode desenvolver o provedor de tipos em uma instância e testar o provedor no outro porque o IDE de teste usará um bloqueio no arquivo. dll que impede que o provedor de tipos seja recriado.</span><span class="sxs-lookup"><span data-stu-id="ca019-451">You can develop the type provider in one instance and test the provider in the other because the test IDE will take a lock on the .dll file that prevents the type provider from being rebuilt.</span></span> <span data-ttu-id="ca019-452">Portanto, você deve fechar a segunda instância do Visual Studio enquanto o provedor é criado na primeira instância e, em seguida, deve reabrir a segunda instância depois que o provedor é compilado.</span><span class="sxs-lookup"><span data-stu-id="ca019-452">Thus, you must close the second instance of Visual Studio while the provider is built in the first instance, and then you must reopen the second instance after the provider is built.</span></span>

### <a name="debug-type-providers-by-using-invocations-of-fscexe"></a><span data-ttu-id="ca019-453">Depurar provedores de tipo usando invocações de fsc.exe</span><span class="sxs-lookup"><span data-stu-id="ca019-453">Debug type providers by using invocations of fsc.exe</span></span>

<span data-ttu-id="ca019-454">Você pode invocar provedores de tipo usando as seguintes ferramentas:</span><span class="sxs-lookup"><span data-stu-id="ca019-454">You can invoke type providers by using the following tools:</span></span>

- <span data-ttu-id="ca019-455">fsc.exe (o compilador de linha de comando F #)</span><span class="sxs-lookup"><span data-stu-id="ca019-455">fsc.exe (The F# command line compiler)</span></span>

- <span data-ttu-id="ca019-456">fsi.exe (o compilador F# Interativo)</span><span class="sxs-lookup"><span data-stu-id="ca019-456">fsi.exe (The F# Interactive compiler)</span></span>

- <span data-ttu-id="ca019-457">devenv.exe (Visual Studio)</span><span class="sxs-lookup"><span data-stu-id="ca019-457">devenv.exe (Visual Studio)</span></span>

<span data-ttu-id="ca019-458">Geralmente, é possível depurar provedores de tipos com mais facilidade usando fsc.exe em um arquivo de script de teste (por exemplo, script. fsx).</span><span class="sxs-lookup"><span data-stu-id="ca019-458">You can often debug type providers most easily by using fsc.exe on a test script file (for example, script.fsx).</span></span> <span data-ttu-id="ca019-459">Você pode iniciar um depurador a partir de um prompt de comando.</span><span class="sxs-lookup"><span data-stu-id="ca019-459">You can launch a debugger from a command prompt.</span></span>

```console
devenv /debugexe fsc.exe script.fsx
```

  <span data-ttu-id="ca019-460">Você pode usar o log de impressão para stdout.</span><span class="sxs-lookup"><span data-stu-id="ca019-460">You can use print-to-stdout logging.</span></span>

## <a name="see-also"></a><span data-ttu-id="ca019-461">Confira também</span><span class="sxs-lookup"><span data-stu-id="ca019-461">See also</span></span>

- [<span data-ttu-id="ca019-462">Provedores de tipos</span><span class="sxs-lookup"><span data-stu-id="ca019-462">Type Providers</span></span>](index.md)
- [<span data-ttu-id="ca019-463">O SDK do provedor de tipos</span><span class="sxs-lookup"><span data-stu-id="ca019-463">The Type Provider SDK</span></span>](https://github.com/fsprojects/FSharp.TypeProviders.SDK)

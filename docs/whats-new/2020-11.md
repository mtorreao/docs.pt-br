...
- [Extrair elementos de uma cadeia de caracteres](../standard/base-types/parse-strings.md) -mover alternativas para fora de `String.Split` referência

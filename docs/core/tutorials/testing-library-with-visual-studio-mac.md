...
## <a name="handle-test-failures"></a><span data-ttu-id="3be37-179">Lidar com falhas de teste</span><span class="sxs-lookup"><span data-stu-id="3be37-179">Handle test failures</span></span>

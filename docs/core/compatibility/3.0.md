...
---
# <a name="breaking-changes-in-net-core-30"></a>Alterações recentes no .NET Core 3,0

Se você estiver migrando para a versão 3,0 do .NET Core, ASP.NET Core ou EF Core, as alterações significativas listadas neste artigo poderão afetar seu aplicativo.

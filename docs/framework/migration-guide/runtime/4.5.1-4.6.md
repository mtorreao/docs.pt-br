...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-46"></a>Alterações de runtime para a migração do .NET Framework 4.5.1 para 4.6

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Se você estiver migrando do .NET Framework 4.5.1 para 4.6, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:

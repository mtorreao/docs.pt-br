...
ms.locfileid: "97009931"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-47"></a><span data-ttu-id="0eb0a-103">Alterações de runtime para a migração do .NET Framework 4.0 para 4.7</span><span class="sxs-lookup"><span data-stu-id="0eb0a-103">Runtime Changes for Migration from .NET Framework 4.0 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="0eb0a-104">Se você estiver migrando do .NET Framework 4.0 para 4.7, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="0eb0a-104">If you are migrating from the .NET Framework 4.0 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="0eb0a-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="0eb0a-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="0eb0a-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="0eb0a-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="0eb0a-107">Núcleo</span><span class="sxs-lookup"><span data-stu-id="0eb0a-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="0eb0a-108">Dados</span><span class="sxs-lookup"><span data-stu-id="0eb0a-108">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="0eb0a-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="0eb0a-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="0eb0a-110">Globalização</span><span class="sxs-lookup"><span data-stu-id="0eb0a-110">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="0eb0a-111">JIT</span><span class="sxs-lookup"><span data-stu-id="0eb0a-111">JIT</span></span>
...
## <a name="linq"></a><span data-ttu-id="0eb0a-112">LINQ</span><span class="sxs-lookup"><span data-stu-id="0eb0a-112">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="0eb0a-113">MEF (Managed Extensibility Framework)</span><span class="sxs-lookup"><span data-stu-id="0eb0a-113">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="0eb0a-114">Rede</span><span class="sxs-lookup"><span data-stu-id="0eb0a-114">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="0eb0a-115">Imprimindo</span><span class="sxs-lookup"><span data-stu-id="0eb0a-115">Printing</span></span>
...
## <a name="security"></a><span data-ttu-id="0eb0a-116">Segurança</span><span class="sxs-lookup"><span data-stu-id="0eb0a-116">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="0eb0a-117">Serialização</span><span class="sxs-lookup"><span data-stu-id="0eb0a-117">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="0eb0a-118">Instalação e Implantação</span><span class="sxs-lookup"><span data-stu-id="0eb0a-118">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="0eb0a-119">Ferramentas</span><span class="sxs-lookup"><span data-stu-id="0eb0a-119">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="0eb0a-120">Aplicativos Web</span><span class="sxs-lookup"><span data-stu-id="0eb0a-120">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="0eb0a-121">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="0eb0a-121">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="0eb0a-122">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="0eb0a-122">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="0eb0a-123">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="0eb0a-123">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="0eb0a-124">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="0eb0a-124">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="0eb0a-125">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="0eb0a-125">XML, XSLT</span></span>

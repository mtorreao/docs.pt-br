...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-472"></a>Alterações de runtime para a migração do .NET Framework 4.0 para 4.7.2

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Se você estiver migrando do .NET Framework 4.0 para 4.7.2, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:

...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-48"></a>Alterações de runtime para a migração do .NET Framework 4.5 para o 4.8

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Se você estiver migrando do .NET Framework 4.5 para 4.8, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que poderão afetar seu aplicativo:

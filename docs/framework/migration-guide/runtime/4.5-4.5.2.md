---
title: Alterações de runtime para a migração do .NET Framework 4.5 para 4.5.2
description: Encontre informações sobre problemas de compatibilidade de aplicativos de alterações de tempo de execução que podem afetar seu aplicativo ao migrar do .NET Framework 4,5 para o 4.5.2.
ms.date: 07/10/2019
...
ms.locfileid: "97009118"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-452"></a><span data-ttu-id="b5420-103">Alterações de runtime para a migração do .NET Framework 4.5 para 4.5.2</span><span class="sxs-lookup"><span data-stu-id="b5420-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="b5420-104">Se você estiver migrando do .NET Framework 4.5 para 4.5.2, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="b5420-104">If you are migrating from the .NET Framework 4.5 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="b5420-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="b5420-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="b5420-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="b5420-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="b5420-107">Núcleo</span><span class="sxs-lookup"><span data-stu-id="b5420-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="b5420-108">Dados</span><span class="sxs-lookup"><span data-stu-id="b5420-108">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="b5420-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="b5420-109">Entity Framework</span></span>
...
## <a name="serialization"></a><span data-ttu-id="b5420-110">Serialização</span><span class="sxs-lookup"><span data-stu-id="b5420-110">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="b5420-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="b5420-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="b5420-112">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="b5420-112">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml"></a><span data-ttu-id="b5420-113">XML</span><span class="sxs-lookup"><span data-stu-id="b5420-113">XML</span></span>

...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-48"></a>Alterações de tempo de execução para migração de .NET Framework 4,0 para 4,8

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Se você estiver migrando do .NET Framework 4,0 para 4,8, examine os seguintes tópicos para problemas de compatibilidade de aplicativos que podem afetar seu aplicativo:

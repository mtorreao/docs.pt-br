---
title: Alterações de tempo de execução para migração de .NET Framework 4,0 para 4,8
description: Encontre informações sobre problemas de compatibilidade de aplicativos de alterações de tempo de execução que podem afetar seu aplicativo ao migrar do .NET Framework 4,0 para 4,8.
ms.date: 07/10/2019
...
ms.locfileid: "97009235"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-48"></a><span data-ttu-id="68552-103">Alterações de tempo de execução para migração de .NET Framework 4,0 para 4,8</span><span class="sxs-lookup"><span data-stu-id="68552-103">Runtime Changes for Migration from .NET Framework 4.0 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="68552-104">Se você estiver migrando do .NET Framework 4,0 para 4,8, examine os seguintes tópicos para problemas de compatibilidade de aplicativos que podem afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="68552-104">If you are migrating from the .NET Framework 4.0 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="68552-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="68552-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="68552-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="68552-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="68552-107">Núcleo</span><span class="sxs-lookup"><span data-stu-id="68552-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="68552-108">Dados</span><span class="sxs-lookup"><span data-stu-id="68552-108">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="68552-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="68552-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="68552-110">Globalização</span><span class="sxs-lookup"><span data-stu-id="68552-110">Globalization</span></span>
...
## <a name="linq"></a><span data-ttu-id="68552-111">LINQ</span><span class="sxs-lookup"><span data-stu-id="68552-111">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="68552-112">MEF (Managed Extensibility Framework)</span><span class="sxs-lookup"><span data-stu-id="68552-112">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="68552-113">Rede</span><span class="sxs-lookup"><span data-stu-id="68552-113">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="68552-114">Imprimindo</span><span class="sxs-lookup"><span data-stu-id="68552-114">Printing</span></span>
...
## <a name="runtime"></a><span data-ttu-id="68552-115">Runtime</span><span class="sxs-lookup"><span data-stu-id="68552-115">Runtime</span></span>

[!INCLUDE[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="68552-116">Segurança</span><span class="sxs-lookup"><span data-stu-id="68552-116">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="68552-117">Serialização</span><span class="sxs-lookup"><span data-stu-id="68552-117">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="68552-118">Instalação e Implantação</span><span class="sxs-lookup"><span data-stu-id="68552-118">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="68552-119">Ferramentas</span><span class="sxs-lookup"><span data-stu-id="68552-119">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="68552-120">Aplicativos Web</span><span class="sxs-lookup"><span data-stu-id="68552-120">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="68552-121">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="68552-121">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="68552-122">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="68552-122">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="68552-123">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="68552-123">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="68552-124">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="68552-124">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="68552-125">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="68552-125">XML, XSLT</span></span>

...
ms.locfileid: "95733081"
---
# <a name="retargeting-changes-for-migration-from-net-framework-471-to-48"></a><span data-ttu-id="eb590-103">Redirecionamento de alterações para migração do .NET Framework 4.7.1 para 4,8</span><span class="sxs-lookup"><span data-stu-id="eb590-103">Retargeting Changes for Migration from .NET Framework 4.7.1 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="eb590-104">Se você estiver migrando do .NET Framework 4.7.1 para 4.8, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que poderão afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="eb590-104">If you are migrating from the .NET Framework 4.7.1 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="eb590-105">Core</span><span class="sxs-lookup"><span data-stu-id="eb590-105">Core</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="eb590-106">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="eb590-106">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="eb590-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="eb590-107">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="eb590-108">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="eb590-108">Windows Workflow Foundation (WF)</span></span>

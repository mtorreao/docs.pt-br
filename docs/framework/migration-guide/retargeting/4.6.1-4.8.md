...
---
# <a name="retargeting-changes-for-migration-from-net-framework-461-to-48"></a>Alterações de redirecionamento para a migração do .NET Framework 4.6.1 para 4.8

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

Se você estiver migrando do .NET Framework 4.6.1 para 4.8, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que poderão afetar seu aplicativo:

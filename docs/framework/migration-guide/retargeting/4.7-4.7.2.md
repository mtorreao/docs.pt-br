...
---
# <a name="retargeting-changes-for-migration-from-net-framework-47-to-472"></a>Alterações de redirecionamento para a migração do .NET Framework 4.7 para 4.7.2

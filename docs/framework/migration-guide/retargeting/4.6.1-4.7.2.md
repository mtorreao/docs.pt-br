...
---
# <a name="retargeting-changes-for-migration-from-net-framework-461-to-472"></a>Alterações de redirecionamento para a migração do .NET Framework 4.6.1 para 4.7.2

---
title: Alterações de redirecionamento para a migração do .NET Framework 4.6.1 para 4.7.2
description: Encontre informações sobre problemas de compatibilidade de aplicativos que podem afetar seu aplicativo ao migrar do .NET Framework 4.6.1 para o 4.7.2.
ms.date: 07/10/2019
...
ms.locfileid: "95732340"
---
# <a name="retargeting-changes-for-migration-from-net-framework-461-to-472"></a><span data-ttu-id="0fa94-103">Alterações de redirecionamento para a migração do .NET Framework 4.6.1 para 4.7.2</span><span class="sxs-lookup"><span data-stu-id="0fa94-103">Retargeting Changes for Migration from .NET Framework 4.6.1 to 4.7.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="0fa94-104">Se você estiver migrando do .NET Framework 4.6.1 para 4.7.2, examine os seguintes tópicos sobre problemas de compatibilidade do aplicativo que podem afetar seu aplicativo:</span><span class="sxs-lookup"><span data-stu-id="0fa94-104">If you are migrating from the .NET Framework 4.6.1 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="0fa94-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="0fa94-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="0fa94-106">Core</span><span class="sxs-lookup"><span data-stu-id="0fa94-106">Core</span></span>
...
## <a name="networking"></a><span data-ttu-id="0fa94-107">Rede</span><span class="sxs-lookup"><span data-stu-id="0fa94-107">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="0fa94-108">Segurança</span><span class="sxs-lookup"><span data-stu-id="0fa94-108">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="0fa94-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="0fa94-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="0fa94-110">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="0fa94-110">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="0fa94-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="0fa94-111">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="0fa94-112">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="0fa94-112">Windows Workflow Foundation (WF)</span></span>

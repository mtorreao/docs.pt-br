...
|------------------|------------------|  
|Guia<br /><br /> <ul><li>TabItem (1 ou mais)</li><li>Barra de rolagem (0 ou 1)<br /><br /> <ul><li>Botão (0 ou 2)</li></ul></li></ul>|Guia<br /><br /> -TabItem (1 ou mais)|  
...
|Exibição de controle|Exibição de conteúdo|  
|------------------|------------------|  
|Guia<br /><br /> <ul><li>TabItem (1 ou mais)</li><li>Grupo (0 ou mais)<br /><br /> <ul><li>TabItem (0 ou mais)</li></ul></li><li>ScrollBar (0 ou mais)<br /><br /> <ul><li>Botão (0 ou 2)</li></ul></li></ul>|Guia<br /><br /> <ul><li>TabItem (1 ou mais)</li><li>Grupo (0 ou mais)<br /><br /> <ul><li>TabItem (0 ou mais)</li></ul></li></ul>|  
...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.ControlTypeProperty>|Guia|Esse valor é o mesmo para todas as estruturas de interface do usuário.|  

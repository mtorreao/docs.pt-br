...
## <a name="service-hosts-in-iis-hosted-applications"></a>Hosts de serviço em aplicativos IIS-Hosted  
...
## <a name="uris-and-iis-hosted-endpoints"></a>URIs e IIS-Hosted pontos de extremidade  
...
## <a name="optimizing-performance-in-middle-tier-scenarios"></a>Otimizando o desempenho em cenários de Middle-Tier  

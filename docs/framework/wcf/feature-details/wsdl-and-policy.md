...
|mssp:SslContextToken|aninhado|Requer que um SecurityContextToken obtido usando handshake TLS binário usando WS-Trust ser usado. As asserções aninhadas incluem: SP: RequireDerivedKeys, MSSP: MustNotSendCancel, MSSP: RequireClientCertificate.|  
...
- [Como: importar o WSDL personalizado](../extending/how-to-import-custom-wsdl.md)

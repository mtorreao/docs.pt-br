...
|Lazy(T)(Func(T), LazyThreadSafetyMode)|Especificado pelo usuário|Sim|Não se o usuário especifica <xref:System.Threading.LazyThreadSafetyMode.PublicationOnly>; caso contrário, sim.|  

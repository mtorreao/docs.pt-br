...
|Aplicativos da loja do Windows 8. x escritos em C++, C# e Visual Basic|[Práticas recomendadas de desempenho para aplicativos da Windows Store usando C++, C# e Visual Basic](/previous-versions/windows/apps/hh750313(v=win.10))|  
|Windows Presentation Foundation (WPF)|[Pacote de desempenho WPF](/previous-versions/dotnet/netframework-4.0/aa969767(v=vs.100))|  
|ASP.NET|[Visão geral do desempenho do ASP.NET](/previous-versions/aspnet/cc668225(v=vs.100))|  

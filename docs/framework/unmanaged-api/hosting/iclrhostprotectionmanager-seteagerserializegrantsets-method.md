...
---
# <a name="iclrhostprotectionmanagerseteagerserializegrantsets-method"></a>Método ICLRHostProtectionManager::SetEagerSerializeGrantSets
...
|HRESULT|Descrição|  
|-------------|-----------------|  
|S_OK|`SetEagerSerializeGrantSets` retornado com êxito.|  

...
## <a name="remarks"></a>Comentários  
 ...
 Um host pode querer um controle exclusivo sobre o número de threads alocados para solicitações de e/s de serviço, por motivos como implementação, desempenho ou escalabilidade. Por esse motivo, o host não precisa implementar `GetMinThreads` . Nesse caso, o host deve retornar E_NOTIMPL desse método.  

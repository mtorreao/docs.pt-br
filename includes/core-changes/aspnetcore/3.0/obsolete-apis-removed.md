...
ms.locfileid: "96032303"
---
### <a name="obsolete-antiforgery-cors-diagnostics-mvc-and-routing-apis-removed"></a><span data-ttu-id="f23ea-101">APIs antifalsificação obsoletas, CORS, diagnóstico, MVC e roteamento removidas</span><span class="sxs-lookup"><span data-stu-id="f23ea-101">Obsolete Antiforgery, CORS, Diagnostics, MVC, and Routing APIs removed</span></span>

<span data-ttu-id="f23ea-102">Os membros obsoletos e as opções de compatibilidade no ASP.NET Core 2,2 foram removidos.</span><span class="sxs-lookup"><span data-stu-id="f23ea-102">Obsolete members and compatibility switches in ASP.NET Core 2.2 were removed.</span></span>

#### <a name="version-introduced"></a><span data-ttu-id="f23ea-103">Versão introduzida</span><span class="sxs-lookup"><span data-stu-id="f23ea-103">Version introduced</span></span>

<span data-ttu-id="f23ea-104">3.0</span><span class="sxs-lookup"><span data-stu-id="f23ea-104">3.0</span></span>

#### <a name="reason-for-change"></a><span data-ttu-id="f23ea-105">Motivo da alteração</span><span class="sxs-lookup"><span data-stu-id="f23ea-105">Reason for change</span></span>

<span data-ttu-id="f23ea-106">Melhoria da superfície da API ao longo do tempo.</span><span class="sxs-lookup"><span data-stu-id="f23ea-106">Improvement of API surface over time.</span></span>

#### <a name="recommended-action"></a><span data-ttu-id="f23ea-107">Ação recomendada</span><span class="sxs-lookup"><span data-stu-id="f23ea-107">Recommended action</span></span>

<span data-ttu-id="f23ea-108">Embora tenha como alvo o .NET Core 2,2, siga as orientações nas mensagens de compilação obsoletas para adotar novas APIs em vez disso.</span><span class="sxs-lookup"><span data-stu-id="f23ea-108">While targeting .NET Core 2.2, follow the guidance in the obsolete build messages to adopt new APIs instead.</span></span>

#### <a name="category"></a><span data-ttu-id="f23ea-109">Categoria</span><span class="sxs-lookup"><span data-stu-id="f23ea-109">Category</span></span>

<span data-ttu-id="f23ea-110">ASP.NET Core</span><span class="sxs-lookup"><span data-stu-id="f23ea-110">ASP.NET Core</span></span>

#### <a name="affected-apis"></a><span data-ttu-id="f23ea-111">APIs afetadas</span><span class="sxs-lookup"><span data-stu-id="f23ea-111">Affected APIs</span></span>

<span data-ttu-id="f23ea-112">Os seguintes tipos e membros foram marcados como obsoletos para ASP.NET Core 2,1 e 2,2:</span><span class="sxs-lookup"><span data-stu-id="f23ea-112">The following types and members were marked as obsolete for ASP.NET Core 2.1 and 2.2:</span></span>

<span data-ttu-id="f23ea-113">**Types**</span><span class="sxs-lookup"><span data-stu-id="f23ea-113">**Types**</span></span>
...
<span data-ttu-id="f23ea-114">**Construtores**</span><span class="sxs-lookup"><span data-stu-id="f23ea-114">**Constructors**</span></span>
...
- [<span data-ttu-id="f23ea-117">Microsoft. AspNetCore. Mvc. Routing. KnownRouteValueConstraint ()</span><span class="sxs-lookup"><span data-stu-id="f23ea-117">Microsoft.AspNetCore.Mvc.Routing.KnownRouteValueConstraint()</span></span>](/dotnet/api/microsoft.aspnetcore.mvc.routing.knownroutevalueconstraint.-ctor?view=aspnetcore-2.2#Microsoft_AspNetCore_Mvc_Routing_KnownRouteValueConstraint__ctor)
...
<span data-ttu-id="f23ea-119">**Propriedades**</span><span class="sxs-lookup"><span data-stu-id="f23ea-119">**Properties**</span></span>
...
<span data-ttu-id="f23ea-120">**Métodos**</span><span class="sxs-lookup"><span data-stu-id="f23ea-120">**Methods**</span></span>
...
- [<span data-ttu-id="f23ea-121">Microsoft. AspNetCore. Mvc. Modelbinding. ParameterBinder. BindModelAsync (ActionContext, IValueProvider, ParameterDescriptor, Object)</span><span class="sxs-lookup"><span data-stu-id="f23ea-121">Microsoft.AspNetCore.Mvc.ModelBinding.ParameterBinder.BindModelAsync(ActionContext,IValueProvider,ParameterDescriptor,Object)</span></span>](/dotnet/api/microsoft.aspnetcore.mvc.modelbinding.parameterbinder.bindmodelasync?view=aspnetcore-2.2#Microsoft_AspNetCore_Mvc_ModelBinding_ParameterBinder_BindModelAsync_Microsoft_AspNetCore_Mvc_ActionContext_Microsoft_AspNetCore_Mvc_ModelBinding_IValueProvider_Microsoft_AspNetCore_Mvc_Abstractions_ParameterDescriptor_System_Object_)
